...
export default {
  ...
  computed: {
    ...
    ...mapState('account/statement', {
      detailTrialBalanceList: state => state.detailTrialBalanceList,
    }),
   ...
   */
  beforeDestroy() {
    this.CLEAR_DETAIL_TRIAL_BALANCE_LIST()
  },

  methods: {
    ...mapMutations('account/statement', ['CLEAR_DETAIL_TRIAL_BALANCE_LIST']),
    ...mapActions('account/statement', ['FETCH_DETAIL_TRIAL_BALANCE_LIST']),
