        ...
        >
          ...
          <template #cell(acctInnerCode)="data">
            <b-form-input v-if="newJournalForm[data.index].isEdit && selectedCell === 'accountCode'" type="text"
                          v-model="newJournalForm[data.index].acctInnerCode" @blur="editCellBlur(data)"></b-form-input>
        ...
        <b-container fluid="sm">
          <b-form>
            <b-row class="mt-1">
              ...
              <b-col sm="1" class="text-sm-right"> <b>환 종</b></b-col>
              <b-col sm="3">
                <div style="display: flex">
                  <b-form-input
                      type="text"
            ...
            <b-row class="mt-1">
              ...
              <b-col sm="1" class="text-sm-right"><b>관리번호</b></b-col>
              <b-col sm="3">
                <b-form-input
                    type="text"
                    v-model:value="newJournalDetailForm.accountControlName"
            ...
            <b-row class="mt-1">
              <b-col sm="1" class="text-sm-right"><b>환 율</b></b-col>
              <b-col sm="3">
                <b-form-input
                    type="text"
                    size="10"
              ...
              <b-col sm="1" class="text-sm-right"><b>관리율</b></b-col>
              <b-col sm="3">
                <b-form-input
                    type="text"
                    size="10"
