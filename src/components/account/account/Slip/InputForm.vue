        ...
        <b-col md="6">
          ...
          >
            <b-form-input
              ...
              id="accountPeriodNo"
              v-model="slipForm.acctPeriodNo"
              disabled
            />
            <b-form-input
              v-else
              id="accountPeriodNo"
              v-model="editSlip[0].acctPeriodNo"
              disabled
            />
          </b-form-group>
        </b-col>
        ...
        <b-col md="6">
          ...
          >
            <b-form-input
              v-if="modalStatus==='addJounal'"
              id="accountCode"
              v-model="journalForm.acctInnerCode"
...
export default {
  ...
  data() {
    return {
      ...
      slipForm: {
        slipNo: 'NEW',
        acctPeriodNo: '6', // 2020년은 기수일련번호 ->  4
        slipType: '결산',
        reportingDate: '',
  ...
  methods: {
    ...
    searchCode() {
      // 문자열이면 true
        ...
        this.journalForm.acctName = this.resultCode.acctName
        this.journalForm.acctInnerCode = this.resultCode.acctInnerCode
    ...
    searchCustomerCode(selectedItem) {
      ...
      this.journalForm.cterCode = customerCode
      this.journalForm.cterName = customerName
    },
