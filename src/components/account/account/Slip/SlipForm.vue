...
export default {
  ...
  methods: {
     ...
     */
    advanceSearch1(val) {
      this.searchTermArray.push(val)
      this.searchTerm1 = val
      this.searchTerm3 = this.searchTerm3
    },

    advanceSearch2(val) {
      this.searchTermArray.push(val)
      this.searchTerm2 = val
      this.searchTerm3 = this.searchTerm3
    },

    advanceSearch3(val) {
      this.searchTermArray.push(val)
      this.searchTerm3 = val},

    searchCode(rows, slipNo, cellValue, searchTerm3) {
      // if(searchTerm1==='' && searchTerm2==='' && searchTerm3==='') {
      //   return true
      // }

      if(this.searchTerm1==='' && this.searchTerm2==='' && searchTerm3==='') {

        return true
      }
      else if(searchTerm3!=='') {
        return rows.slipNo.indexOf(searchTerm3)> -1}
